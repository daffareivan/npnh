    ...
    <div class="space-y-6">
        <x-common.component-card title="Line chart 1">
            ...
            <div class="custom-scrollbar max-w-full overflow-x-auto">
                <div id="chartThree" class="min-w-[600px] xl:min-w-full"></div>
            </div>
            <!-- ====== Line Chart One End -->
        ...
        <x-common.component-card title="Line chart 2">
            ...
            <div class="custom-scrollbar max-w-full overflow-x-auto">
                <div id="chartEight" class="min-w-[600px] xl:min-w-full"></div>
            </div>
            <!-- ====== Line Chart Two End -->
        </x-common.component-card>
        ...
        <x-common.component-card title="Line chart 3">
            ...
            <div class="custom-scrollbar max-w-full overflow-x-auto">
                <div id="chartThirteen" class="min-w-[600px] xl:min-w-full"></div>
            </div>
