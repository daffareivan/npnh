...
@section('content')
    ...
    <div class="grid gap-6 lg:grid-cols-2">
        ...
        <x-common.component-card title="Daily / Weekly / Monthly Conversion"><div class="wx-decor-glow h-40 rounded-[20px] border border-white/[0.05] bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,.10),transparent_13rem)]"></div></x-common.component-card>
        <x-common.component-card title="Storage Growth & Download Count"><div class="wx-decor-glow h-40 rounded-[20px] border border-white/[0.05] bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,.10),transparent_13rem)]"></div></x-common.component-card>
    </div>
@endsection
